...
/* Brand-style SVG icons (currentColor for theme) */
const IconEmail = () => (
...
const FOOTER_ICONS = [
  { Icon: IconEmail, label: 'Email', href: 'mailto:sports.oc@pucit.edu.pk' },
  { Icon: IconFacebook, label: 'Facebook', href: 'https://facebook.com/PucitSSOldCampus/' },
  { Icon: IconInstagram, label: 'Instagram', href: 'https://instagram.com/fcit_oc_sports' },
  { Icon: IconLinkedIn, label: 'LinkedIn', href: 'https://linkedin.com/company/fcit-sports-society-oc/' },
] as const;
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              {FOOTER_ICONS.map(({ Icon, label, href }) => (
                <a
                  key={label}
                  href={href}
